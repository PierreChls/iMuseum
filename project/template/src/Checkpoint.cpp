...
{   
    this->model = Model("assets/models/barrel/Barrell_oak_obj.obj", shader_name, rotate_angle, rotate_x, rotate_y, rotate_z, translate_x, translate_y, translate_z, scale );
}
